                        ...
                        >
                            ...
                            >
                                {contactInfo.map((info, index) => (
                                    <div key={index} className="bg-white rounded-xl p-2 text-center hover:shadow-xl transition-shadow duration-300">
